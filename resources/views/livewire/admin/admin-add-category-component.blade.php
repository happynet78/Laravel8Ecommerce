                    ...
                    <div class="panel-body">
                        ...
                        <form action="" class="form-horizontal" wire:submit.prevent="storeCategory">
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <input type="text" name="" id="" class="form-control input-md" placeholder="Category Name..." wire:model="name" wire:keyup="generateslug" />
                                </div>
                            </div>
							...
							<div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <input type="text" name="" id="" class="form-control input-md" placeholder="Category Slug..." wire:model="slug" />
                                </div>
                            </div>
