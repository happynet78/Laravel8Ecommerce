						...
						<div class="wrap-address-billing">
							...
							<div class="billing-address">
								...
								<p class="row-in-form">
									...
									<input type="text" name="country" value="" placeholder="Province" wire:model="s_province">
					...
					<div class="summary-item payment-method">
						...
						<div class="wrap-address-billing">
							...
							<p class="row-in-form">
								...
								<input type="password" name="cvs" value="" placeholder="CVS" wire:model="cvs">
								@error('cvs') <span class="text-danger">{{ $message }}</span> @enderror
							</p>
						</div>
						@endif
						...
						@endif
						<button type="submit" class="btn bt-medium">Place order now</button>
					</div>
